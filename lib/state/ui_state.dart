...
class UIStateData {
  ...
  factory UIStateData.fromJson(Map<String, dynamic> json) {
    return UIStateData(
      ...
      appBarColor: Color(json['appBarColor'] as int? ?? AppColors.defaultBackgroundColor.toARGB32()),
      ...
      fontColor: Color(json['fontColor'] as int? ?? AppColors.defaultFontColor.toARGB32()),
      ...
      textFieldBackgroundColor: Color(json['textFieldBackgroundColor'] as int? ?? AppConstants.defaultTextFieldBackgroundColor.toARGB32()),
      textFieldBorderColor: Color(json['textFieldBorderColor'] as int? ?? AppConstants.defaultTextFieldBorderColor.toARGB32()),
